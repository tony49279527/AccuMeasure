...
export function GET() {
  const staticContentLastModified = "2026-08-29T00:00:00.000Z";
  const productCatalogLastModified = "2026-08-29T00:00:00.000Z";
  const applicationsIndexLastModified = "2026-08-29T00:00:00.000Z";
