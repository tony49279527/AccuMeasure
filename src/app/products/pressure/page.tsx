...
const data: CategoryPageData = {
  ...
  description: `Industrial pressure transmitters and digital pressure gauges. 0–10kPa to 0–100MPa range. ±0.25% to ±0.5% FS accuracy. ATEX Ex d IIC T6 certified. Aerospace-grade vibration resistance. From $${priceFrom}. AccuMeasureTech factory, Xi'an.`,
